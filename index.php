...
<body class="bg-white font-outfit text-gray-800">
        ...
        <div class="flex justify-between items-center px-6 py-1.5 bg-white relative">
            ...
            <nav class="hidden md:flex space-x-6 text-md font-Outfit font-medium relative">
                ...
                <div class="relative dropdown">
                    ...
                    <div id="dropdown1"
                        class="absolute hidden mt-2 w-40 bg-white border border-[#A435F0] shadow rounded z-50">
                ...
                <div class="relative dropdown">
                    ...
                    <div id="dropdown2"
                        class="absolute hidden mt-2 w-40 border border-[#A435F0] bg-white shadow rounded z-50">
            ...
            <div class="space-x-2 text-md font-Outfit font-medium">
                <a href="frontend/signup.php" class="hover:text-[#A435F0]">Login</a>
                <a href="frontend/signup.php" class="bg-[#A435F0] text-white px-4 py-2 rounded-full">Sign up</a>
            </div>
        </div>

        <!-- Quiz Code Join Bar -->
        <div
            class="relative bg-[#E1B6FF] text-center py-3 px-4 flex justify-center items-center space-x-2 text-md font-Outfit">
            <span>Enter Code to join a live quiz</span>
            <input type="text" maxlength="6" inputmode="numeric"
                oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="123 456" pattern="\d{6}"
                class="px-3 py-1 rounded border border-gray-300 w-24 text-center">
    ...
    <section class="text-center pt-16 px-4">
        ...
        <a href="frontend/signup.php"
            class="text-xl inline-block bg-[#E1B6FF] text-black px-6 py-2 rounded-full hover:bg-[#A435F0] hover:text-white transition">
    ...
    <video autoplay muted loop playsinline style="width: 100%; height: auto;">
        <source src="assets/video/QuizEraAnimation.mp4" type="video/mp4">Your browser does not support the video tag.
    </video>
    <section class="py-16 px-4 bg-white text-center">
        ...
        <p class="pb-20 max-w-xl mx-auto text-[#1E1E1E] mb-10">
            With thousands of ready-made quizzes on demand, diverse question types, and national leaderboards, QuizEra
            is your ultimate destination for fun and competitive quizzing. Perfect for:
        </p>
        ...
        <div class="max-w-6xl mx-auto space-y-12">
            ...
            <div class="flex flex-col pb-12 md:flex-row items-center md:items-start gap-6">
                <img src="assets/images/FamilyPic.png" alt="Family and Friends"
                    class="w-full md:w-1/2 rounded-3xl shadow-md">
                <div class="text-left md:w-1/2 flex flex-col justify-center text-center">
                    ...
                    <p class="text-black mb-4 py-2">
                        Gather your friends and family for a fun, interactive quiz experience! With categories ranging
                        from trending topics to nostalgia, QuizEra makes quiz nights unforgettable. Let the fun begin!
                    </p>
                    <div><button class="bg-gray-200 text-gray-800 px-4 py-2 w-fit rounded-full hover:bg-[#FFA83D]">Learn
                            More</button></div>
                </div>
            </div>
            ...
            <div class="flex flex-col pb-12 md:flex-row-reverse items-center md:items-start gap-6">
                <img src="assets/images/image.png" alt="Schools and Colleges"
                    class="w-full md:w-1/2 rounded-3xl shadow-md">
                <div class="text-left md:w-1/2 flex flex-col justify-center text-center">
                    <h3 class="text-4xl mt-10 font-semibold text-[#FEC02C] mb-2">Schools & Colleges</h3>
                    <p class="text-black mb-4 py-2">
                        Bring your classrooms and peers together for an exciting, quiz-based learning experience.
                        QuizEra's quizzes are perfect for skill assessment, engagement, and group competitions.
                    </p>
                    <div><button class="bg-gray-200 text-gray-800 px-4 py-2 w-fit rounded-full hover:bg-[#FFA83D]">Learn
                            More</button></div>
                </div>
            ...
            <!-- Events & Occasions -->
            <div class="flex flex-col pb-12 md:flex-row items-center md:items-start gap-6">
                <img src="assets/images/image2.png" alt="Events and Occasions"
                    class="w-full md:w-1/2 rounded-3xl shadow-md">
                <div class="text-left md:w-1/2 flex flex-col justify-center text-center">
                    <h3 class="text-4xl mt-10 font-semibold text-[#4A1F96] mb-2">Events & Occasions</h3>
                    <p class="text-black mb-4 py-2">
                        Make every event and occasion unforgettable with a QuizEra quiz! From birthdays to office
                        parties, our quizzes add energy, laughter, and a touch of friendly rivalry.
                    </p>
                    <div><button class="bg-gray-200 text-gray-800 px-4 py-2 w-fit rounded-full hover:bg-[#FFA83D]">Learn
                            More</button></div>
                </div>
            ...
            <!-- Survey & Feedback -->
            <div class="flex flex-col pb-12 md:flex-row-reverse items-center md:items-start gap-6">
                <img src="assets/images/image3.png" alt="Survey and Feedback"
                    class="w-full md:w-1/2 rounded-3xl shadow-md">
                <div class="text-left md:w-1/2 flex flex-col justify-center text-center">
                    <h3 class="text-4xl mt-10 font-semibold text-[#78D6FE] mb-2">Survey & Feedback</h3>
                    <p class="text-black mb-4 py-2">
                        Turn surveys and feedback into an engaging experience with QuizEra! Whether for product reviews
                        or training feedback, make responses easy, insightful, and enjoyable.
                    </p>
                    <div><button class="bg-gray-200 text-gray-800 px-4 py-2 w-fit rounded-full hover:bg-[#FFA83D]">Learn
                            More</button></div>
                </div>
    ...
    <section class="py-16 px-6 text-center bg-white">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <!-- Create -->
            <div
                class="border-2 border-[#E1B6FF] rounded-xl p-6 shadow-sm hover:shadow-md hover:border-[#A435F0] transition">
                <div>
                    <h4 class="text-4xl font-medium text-[#FE4D48] flex mb-4">Create</h4>
                </div>
                <img src="assets/images/create.png" alt="Create Quiz"
                    class="w-full h-auto rounded-xl mx-auto mb-4 object-contain">
                <p class="text-black text-sm font-medium">
                    Choose from a predefined templates for a quick and hassle-free setup, or Create your own quiz by
                    selecting questions
                </p>
            </div>
            ...
            <div
                class="border-2 border-[#E1B6FF] rounded-xl p-6 shadow-sm hover:shadow-md hover:border-[#A435F0] transition">
                <div>
                    <h4 class="text-4xl font-medium text-[#165DFC] flex mb-4">Host</h4>
                </div>
                <img src="assets/images/host.png" alt="Host Quiz"
                    class="w-full h-auto rounded-xl mx-auto mb-4 object-contain">
                <p class="text-black text-sm font-medium">
                    Once you’ve selected your questions, hosting the quiz is a breeze! With just a Clicks, launch your
                    quiz
                </p>
            </div>
            ...
            <div
                class="border-2 border-[#E1B6FF] rounded-xl p-6 shadow-sm hover:shadow-md hover:border-[#A435F0] transition">
                <div>
                    <h4 class="text-4xl font-medium text-[#39D766] flex mb-4">Play</h4>
                </div>
                <img src="assets/images/play.png" alt="Play Quiz"
                    class="w-full h-auto rounded-xl mx-auto mb-4 object-contain">
                <p class="text-black text-sm font-medium">
    ...
    <section
        class="bg-[url('assets/images/design1.png')] bg-cover bg-center text-white text-center py-16 px-4 z-50 w-auto h-[296px]">
        ...
        <button onclick="window.location.href='frontend/signup.php'" class="bg-[#525252] text-white font-medium px-9 py-4 rounded-full transition">
            Get started now
        </button>
    </section>
    <footer class="bg-white text-gray-800 pt-10 w-full">
        <div
            class="w-full mx-auto py-10 px-4 flex flex-col md:flex-row justify-between items-start space-y-10 md:space-y-0 md:space-x-12">
        ...
        <!-- Bottom Bar -->
        <div
            class=" border-t-2 border-[#A435F0] mt-10 py-4 px-10 flex flex-col md:flex-row justify-between items-center text-md">
