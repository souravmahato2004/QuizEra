<div class="w-[363px] bg-white shadow-md h-full fixed flex flex-col px-4 border-r border-[#BE92DC]">
        <div class="flex flex-row items-center h-1/6 w-full">
            <a href="mainPage.php"><img src="../assets/logo/QuizEra.png" alt="Logo" class="w-2/3 h-1/2"></a>
        ...
        <ul class="space-y-3 text-gray-700 text-sm mt-16 pl-5">
            <li>
                <a href="#" class="text-xl text-[#000000] font-medium"> Manage Profile</a>
            </li>
            <li>
                <a href="#" class="text-xl text-[#797979] font-medium"> Account Settings</a>
            </li>
            <li>
                <a href="#" class="text-xl text-[#797979] font-medium"> Billing & Pricing</a>
            </li>
        </ul>
